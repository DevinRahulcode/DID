...
import com.bitdottech.Shield.models.User;
...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView step;
    ImageView pin;
    ImageButton MOTI,AMBUCall,POlI199;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        POlI199 = findViewById(R.id.callpoli119);
...
//        });
        ...
        MOTI = findViewById(R.id.motivation);
        ...
        Infor = findViewById(R.id.inforbtn);
...
//                                        sms.sendTextMessage(user.getTelephoneNumber(), null, "\"https://www.google.com/maps/@?api=1&map_action=map&AIzaSyBKN1uQEd-Saq99wM8OQXGXBw9WeoHITec",
//                                                null, null);
//
//                                    } catch (Exception e) {
...
//                                    }
        ...
        Button btnLogout=findViewById(R.id.btn_dv);
